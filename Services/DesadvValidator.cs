...
/// </summary>
public class DesadvValidator
{
    private readonly List<ValidationIssue> _issues = new();
    private readonly GlnStore _store;

    public DesadvValidator(GlnStore store) => _store = store;
    ...
    private void ValidateSyntax(EdifactInterchange ic)
    {
        ...
        foreach (var msg in ic.Messages)
        {
            ...
            if (msg.MessageType != "DESADV")
                Err("UNH", msg.Unh.SegmentIndex, msg.Unh.LineNumber, "DE2.C1", "DESADV_SYN_006", "desadv.syn.006");
        }
    }

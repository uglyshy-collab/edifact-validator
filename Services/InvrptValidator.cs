...
/// </summary>
public class InvrptValidator
{
    private readonly List<ValidationIssue> _issues = new();
    private readonly GlnStore _store;

    public InvrptValidator(GlnStore store) => _store = store;
    ...
    private void ValidateSyntax(EdifactInterchange ic)
    {
        ...
        foreach (var msg in ic.Messages)
        {
            ...
            if (msg.MessageType != "INVRPT")
                Err("UNH", msg.Unh.SegmentIndex, msg.Unh.LineNumber, "DE2.C1", "INVRPT_SYN_006", "invrpt.syn.006");
        }
    }
    ...
    private void CheckNad(Dictionary<string, EdifactSegment> nads, string qualifier, string code, string key)
    {
